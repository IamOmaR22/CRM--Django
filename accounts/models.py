...
class Customer(models.Model):
    user = models.OneToOneField(User, null=True, on_delete=models.CASCADE) # one to one relationships(one customer can have one user and one user can have one customer)
